    ...
    return (
        <div className={`space-y-6 ${className}`}>
            <div className="space-y-1">
                <h2 className="text-lg md:text-xl font-bold text-[#1C3A37]">{label}</h2>
            ...
            <div className="bg-[#FFFFF0] rounded-[32px] p-6 md:p-8 space-y-8 border border-[#F0F0D8]">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        <span className="text-xs font-bold uppercase tracking-wider text-[#1C3A37]">Score</span>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-sm font-bold text-gray-600 w-6">{score}</span>
                    </div>
                </div>

                {/* Feedback Editor */}
                <div className="space-y-4">
                    <span className="text-xs font-bold uppercase tracking-wider text-[#1C3A37]">Feedback</span>
