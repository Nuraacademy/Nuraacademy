    ...
    return (
        <section className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-lg md:text-xl font-bold text-[#1C3A37]">Assignments</h2>
                <button onClick={() => router.push('/assignment')} className="text-sm font-bold text-gray-400 hover:text-[#1C3A37] transition-colors flex items-center gap-1">
