            ...
            >
                <div className="relative z-10 flex flex-col justify-between h-full space-y-6 md:space-y-8">
                    <div className="flex justify-between items-start">
                        <span className="text-5xl md:text-6xl font-medium tracking-tighter">{totalLearners}</span>
                    ...
                    <p className="text-white/80 font-medium text-base md:text-lg leading-tight uppercase tracking-widest">Manage<br />user access</p>
                </div>
