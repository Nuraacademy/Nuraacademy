  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F5F5EC] px-4 text-center">
      <div className="bg-white p-8 rounded-[2rem] shadow-xl max-w-md w-full border border-gray-100 italic">
        <h2 className="text-3xl font-bold text-[#005954] mb-4">Something went wrong!</h2>
        ...
        <div className="flex flex-col gap-3">
            <button
                onClick={() => reset()}
                className="bg-[#94B546] text-white py-3 rounded-full font-bold hover:bg-[#83a13d] transition-all"
            >
                Try again
            </button>
            <button
                onClick={() => router.push('/')}
                className="bg-[#005954] text-white py-3 rounded-full font-bold hover:bg-[#004743] transition-all"
            >
                Go to Home
            </button>
        </div>
