    ...
    return (
        <div className="min-h-screen bg-[#FDFDF7] px-6 md:px-10 py-8 space-y-8 font-sans">
            ...
            <div className="bg-[#005954] rounded-[1.5rem] p-6 text-white shadow-sm">
                <h1 className="text-xl font-bold mb-1">{data.course.title} Reflection Feedback</h1>
            ...
            <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 flex flex-col gap-6">
                <h2 className="text-sm font-bold text-gray-900 px-2">Hasil Refleksi Learners</h2>
                
                <div className="border border-gray-200 rounded-[2rem] overflow-hidden">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-gray-200">
                                <th className="px-8 py-4 text-xs font-bold text-gray-900 uppercase tracking-wider">Name</th>
                                <th className="px-8 py-4 text-xs font-bold text-gray-900 uppercase tracking-wider text-right">Feedback</th>
                            </tr>
                        </thead>
                            ...
                            {reflections.map((reflection) => (
                                ...
                                >
                                    ...
                                    <td className="px-8 py-6 text-right">
                                        <button 
                                            className={`px-6 py-1.5 rounded-full text-[10px] font-bold transition-colors ${
                                                reflection.feedback ? 'bg-[#D9F55C] text-black' : 'bg-[#D9F55C] text-black'
                                            }`}
                                        >
                                            Feedback
                                        </button>
