            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-8 space-y-8 transition-all duration-300 md:pl-80">
                ...
                <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-gray-100 flex flex-col gap-8">
                    <div className="space-y-4">
                        <h2 className="text-sm font-bold text-gray-900 uppercase tracking-tight">Feedback Answer</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 bg-[#DAEE49] text-[#005954] rounded-full text-xs font-bold hover:bg-[#C9D942] transition-colors ${isUploading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
                    ...
                    <div className="flex justify-end items-center gap-8 pt-8 border-t border-transparent">
                        ...
                        <NuraButton 
                            ...
                            variant="primary"
                            className="min-w-[160px] h-12 text-sm font-bold bg-[#DAEE49] text-[#005954] hover:bg-[#C9D942] rounded-xl"
                            onClick={handleSave}
