...
export function PreTestClient({ classId, testId, questions, testData }: { classId: string, testId: string, questions: any[], testData: any }) {
            ...
            <div className="mt-4">
                <TestRunner
                    ...
                    pageText={{
                        ...
                        finishedDescription: "Thank you for completing the pre-test.",
        ...
        <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-gray-100">
            ...
            <div className="mb-12">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                    This pre-test is designed to assess your current knowledge of the module topics.
                </p>
            </div>
