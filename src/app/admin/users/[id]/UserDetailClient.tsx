    ...
    return (
        <div className="min-h-screen bg-[#F9F9EE] relative overflow-hidden font-sans">
            ...
            <div className="relative z-10 px-4 md:px-16 py-12 max-w-7xl mx-auto">
                ...
                <Link 
                    href="/admin/users" 
                    className="inline-flex items-center gap-2 text-[#005954] font-bold text-sm mb-8 hover:translate-x-[-4px] transition-transform"
                >
                    ...
                    <div className="lg:w-1/3 space-y-8">
                        <div className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-black/5 border border-white">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[#005954] to-[#00897B] flex items-center justify-center text-white font-bold text-4xl mb-6 shadow-lg border-4 border-[#D9F55C]/20">
                                ...
                                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#D9F55C]/20 border border-[#D9F55C]/30 rounded-full text-xs font-bold text-[#005954] uppercase tracking-wider mb-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-2 md:col-span-2">
                                        <div className="flex justify-between items-center ml-1">
                                            ...
                                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider bg-gray-50 px-2 py-0.5 rounded">Optional</span>
                                        </div>
                                        <input 
                                            type="password" 
                                            className="w-full px-6 py-4 bg-[#FDFDF7] border border-transparent rounded-2xl outline-none focus:bg-white focus:border-[#D9F55C] focus:shadow-inner transition-all text-sm font-medium"
